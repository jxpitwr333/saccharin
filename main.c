...
char* tokenTypeToString(TokenType type) {
	switch(type) {
		case TOKEN_LEFT_PAREN: 	return "("; break;
		case TOKEN_RIGHT_PAREN: return ")"; break;
		case TOKEN_LEFT_BRACE: 	return "{"; break;
		case TOKEN_RIGHT_BRACE: return "}"; break;
		...
		case TOKEN_STAR: 		return "*"; break;
		case TOKEN_BANG: 		return "!"; break;
		case TOKEN_BANG_EQUAL: 	return "!="; break;
		...
		case TOKEN_SUPER: 		return "super"; break;
		case TOKEN_THIS: 		return "this"; break;
...
char* tokenToString(Token token) {
	return arena_sprintf(&arena, "%s %s %s", tokenTypeToString(token.type), token.lexeme, literalToString(token.literal));
}
